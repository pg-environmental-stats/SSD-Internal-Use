shinyServer(function(input, output, session){
  ...
  observeEvent(newVars(),{
    ...
    if(!input$doGrps){
      ...
      outputDT.1 <- as.datatable(formattable(testData[,c("species","responses")],
                                             #align =c("r","l"),
                                             list(
                                               species = formatter("span", style = species ~ formattable::style(color = "blue",font.style = "italic")),
                                               responses = formatter("span", style = responses ~ formattable::style(color="green", float="right")))),
                                 class = 'stripe compact',
                                 #escape = FALSE,
                                 options = list(#columnDefs = list(list(className = 'dt-right', targets = "_all")),
                                   #autoWidth = TRUE,
    ...
    if(input$doGrps){
      ...
      outputDT.1 <- as.datatable(formattable(testData[,c("species","responses","groups")],
                                             #align =c("r","l"),
                                             list(
                                               species = formatter("span", style = input$sort_x ~ formattable::style(color = "blue",font.style = "italic")),
                                               responses = formatter("span", style = input$sort_y ~ formattable::style(color="green", float="right")),
                                               groups=formatter("span", style = input$sort_z ~ formattable:: style(color = "blue")))),
                                 class = 'stripe compact',
                                 #escape = FALSE,
                                 options = list(#columnDefs = list(list(className = 'dt-right', targets = "_all")),
                                   #autoWidth = TRUE,
  ...
  observeEvent(newVars(),{
    ...
    outputDT <- as.datatable(formattable(outputData,
                                         #align =c("r","l"),
                                         list(
                                           'Exposure Conc' = formatter("span", style = input$sort_x ~ formattable::style(float="right")),
                                           'Response Count' = formatter("span", style = input$sort_y ~ formattable::style(float="right")),
                                           'Group Size' = formatter("span", style = input$sort_z ~ formattable::style(float="right")))),
                             class = 'stripe compact',
                             #escape = FALSE,
                             options = list(columnDefs = list(list(className = 'dt-right', targets = "_all")),
                                            #autoWidth = TRUE,
  ...
  observeEvent(newVars(),{
    ...
    outputDT <- as.datatable(formattable(outputData,
                                         #align =c("r","l"),
                                         list(
                                           'Exposure Conc' = formatter("span", style = input$sort_x ~ formattable::style(color = "blue",font.style = "italic")),
                                           'Response' = formatter("span", style = input$sort_y ~ formattable::style(color="green", float="right")))),
                             class = 'stripe compact',
                             #escape = FALSE,
                             options = list(columnDefs = list(list(className = 'dt-right', targets = "_all")),
                                            #autoWidth = TRUE,
  ...
  observe({
    ...
    output$graphOpts <- renderUI({
      tagList(
        h3("Finalize inputs above",formattable::style="color: red"))})
  ...
  observe({
    ...
    if(length(unique(c(input$sort_x,input$sort_y,input$sort_z)))<3)
      output$graphOpts <- renderUI({
        tagList(
          h3("Resolve duplicate variables above",formattable::style="color: red"))})
  ...
  observeEvent(input$previewData,{
    ...
    if(input$analysisType=="SSD"){
      ...
      if(!input$doGrps){
        ...
        outputDT <- as.datatable(formattable(outputData,
                                             #align =c("r","l"),
                                             list(
                                               'Species Label' = formatter("span", style = input$sort_x ~ formattable::style(color = "blue",font.style = "italic")),
                                               'Effect Concentration' = formatter("span", style = input$sort_y ~ formattable::style(color="green", float="right")))),
                                 class = 'stripe compact',
                                 #escape = FALSE,
      ...
      if( input$doGrps){
        ...
        outputDT <- as.datatable(formattable(outputData,
                                             ...
                                             list(
                                               'Species Label' = formatter("span", style = input$sort_x ~ formattable::style(color = "blue",font.style = "italic")),
                                               'Effect Concentration' = formatter("span", style = input$sort_y ~ formattable::style(color="green", float="right")),
                                               Grouping=formatter("span", style = input$sort_z ~ formattable::style(color = colorList[match(outputData$Group,unique(outputData$Group))])))),
                                 class = 'stripe compact',
                                 #escape = FALSE,
                                 options = list(columnDefs = list(list(className = 'dt-right', targets = 2)),
                                   #autoWidth = TRUE,
    ...
    if(input$analysisType=="Continuous"){
      ...
      outputDT <- as.datatable(formattable(outputData,
                                           ...
                                           list(
                                             'Exposure Conc' = formatter("span", style = input$sort_x ~ formattable::style(float="right")),
                                             'Response' = formatter("span", style = input$sort_y ~ formattable::style(float="right")))),
                               class = 'stripe compact',
                               #escape = FALSE,
                               options = list(columnDefs = list(list(className = 'dt-right', targets = "_all")),
                                              #autoWidth = TRUE,
